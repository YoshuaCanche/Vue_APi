      ...
      <div class="row">
        <div id="menu" class="col-2">
          <div class="container">
            ...
            <div class="row">
              <router-link :to="{ path: '/GetC' }" type="button" class="btn btn-outline-secondary">Ver Usuarios</router-link>
            </div>
            <div class="row">
              <!-- <router-link :to="{name:'/get'}" type="button" class="btn btn-outline-secondary">Insert</router-link> -->
              <router-link :to="{ path: '/PostC' }" type="button" class="btn btn-outline-secondary">Insertar  </router-link>
            </div>
            <!-- <div class="row">
