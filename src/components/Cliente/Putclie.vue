        ...
        <div class="card">
            ...
            <div class="card-body">
                <form v-on:submit.prevent="formulario">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div id="botonbusca">
                                    ...
                                    &#160
                                    <router-link :to="{ name: 'Getclie' }" class="btn btn-outline-danger">Cancelar</router-link>
                                </div>
                            </div>
                        </div>
                    ...
                    <br>
                    <div id="botoncerrar" style="display: none;">|<router-link :to="{name:'Getclie'}" type="button" class="btn btn-outline-primary">Finalizar</router-link>|</div>
    ...
    methods: {
        formulario() {
            ...
            axios.put('https://localhost:7051/Cliente?id=' + this.pkCliente, cuerpo).then((resutl) => {
                ...
                this.smg = "Se registro actualizo Correctamentente";
